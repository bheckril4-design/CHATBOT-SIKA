...
const trimGlobals = (entries) =>
	Object.fromEntries(Object.entries(entries).map(([key, value]) => [key.trim(), value]));
...
export default [
	...
	},
	{
		...
		languageOptions: {
			...
			globals: { ...trimGlobals(globals.browser), React: 'readonly', Intl: 'readonly' },
		},
		settings: {
		...
		rules: {
			...
			'import/no-unresolved': 'off', // Project aliases and optional generated files make this noisy
			'import/default': 'off', // Same as above
			'import/named': 'off', // Same as above
			'import/namespace': 'off', // Same as above
	...
	{ files: ['tools/**/*.js', 'tailwind.config.js'], languageOptions: { globals: trimGlobals(globals.node) } },
];
